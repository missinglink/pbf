...
GOOS=linux GOARCH=arm go build -ldflags="-s -w" pbf.go;
echo $?;
assert $?;
chmod +x pbf;
...
# GOOS=linux GOARCH=386 go build -ldflags="-s -w" pbf.go;
# assert $?;
# chmod +x pbf;
...
GOOS=darwin GOARCH=amd64 go build -ldflags="-s -w" pbf.go;
assert $?;
chmod +x pbf;
...
# GOOS=darwin GOARCH=386 go build -ldflags="-s -w" pbf.go;
# assert $?;
# chmod +x pbf;
...
GOOS=windows GOARCH=386 go build -ldflags="-s -w" -o pbf.exe pbf.go;
assert $?;
chmod +x pbf.exe;
...
# GOOS=windows GOARCH=386 go build -ldflags="-s -w" pbf.go;
# assert $?;
# chmod +x pbf.exe;
...
# GOOS=freebsd GOARCH=arm go build -ldflags="-s -w" pbf.go;
# assert $?;
# chmod +x pbf;
...
# GOOS=freebsd GOARCH=amd64 go build -ldflags="-s -w" pbf.go;
# assert $?;
# chmod +x pbf;
...
# GOOS=freebsd GOARCH=386 go build -ldflags="-s -w" pbf.go;
# assert $?;
# chmod +x pbf;
...
# GOOS=openbsd GOARCH=386 go build -ldflags="-s -w" pbf.go;
# assert $?;
# chmod +x pbf;
...
# GOOS=openbsd GOARCH=amd64 go build -ldflags="-s -w" pbf.go;
# assert $?;
# chmod +x pbf;
